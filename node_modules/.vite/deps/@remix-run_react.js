...
// node_modules/@remix-run/react/node_modules/cookie/index.js
var require_cookie = __commonJS({
  "node_modules/@remix-run/react/node_modules/cookie/index.js"(exports) {
    "use strict";
...
function Navigate(_ref4) {
  ...
  React.useEffect(() => navigate(JSON.parse(jsonPath), {
    ...
    state,
    relative
  }), [navigate, jsonPath, relative, replace4, state]);
  return null;
}
...
// node_modules/@remix-run/react/node_modules/@remix-run/server-runtime/dist/esm/cookies.js
...
var json2 = function json3(data3, init) {
  if (init === void 0) {
    init = {};
  }
  ...
  return new Response(JSON.stringify(data3), _extends5({}, responseInit, {
    headers
  }));
};
...
var DeferredData = class {
  constructor(data3, responseInit) {
    ...
    this.deferredKeys = [];
    invariant3(data3 && typeof data3 === "object" && !Array.isArray(data3), "defer() only accepts plain objects");
    let reject;
...
var defer2 = function defer3(data3, init) {
  if (init === void 0) {
    init = {};
  }
  let responseInit = typeof init === "number" ? {
...
var redirect3 = function redirect4(url, init) {
  if (init === void 0) {
    init = 302;
  }
  let responseInit = init;
...
function createRouter3(init) {
  ...
  async function handleAction(request, location, submission, matches, isFogOfWar, opts) {
    ...
    if (isRedirectResult(result)) {
      ...
      if (opts && opts.replace != null) {
        ...
        replace4 = location2 === state.location.pathname + state.location.search;
      }
  ...
  async function handleLoaders(request, location, matches, isFogOfWar, overrideNavigation, submission, fetcherSubmission, replace4, initialHydration, flushSync, pendingActionResult) {
    ...
    let redirect6 = findRedirect(loaderResults);
    if (redirect6) {
      await startRedirectNavigation(request, redirect6.result, true, {
        replace: replace4
      });
      return {
        shortCircuited: true
    ...
    redirect6 = findRedirect(fetcherResults);
    if (redirect6) {
      fetchRedirectIds.add(redirect6.key);
      await startRedirectNavigation(request, redirect6.result, true, {
        replace: replace4
      });
      return {
  ...
  async function handleFetcherAction(key, routeId, path, match, requestMatches, isFogOfWar, flushSync, preventScrollReset, submission) {
    ...
    let redirect6 = findRedirect(loaderResults);
    if (redirect6) {
      return startRedirectNavigation(revalidationRequest, redirect6.result, false, {
        preventScrollReset
      });
    }
    redirect6 = findRedirect(fetcherResults);
  ...
  async function startRedirectNavigation(request, redirect6, isNavigation, _temp2) {
    let {
      submission,
      fetcherSubmission,
      preventScrollReset,
    ...
    if (redirect6.response.headers.has("X-Remix-Revalidate")) {
      isRevalidationRequired = true;
    }
    let location = redirect6.response.headers.get("Location");
    ...
    if (isBrowser2) {
      ...
      if (redirect6.response.headers.has("X-Remix-Reload-Document")) {
    ...
    pendingNavigationController = null;
    let redirectHistoryAction = replace4 === true || redirect6.response.headers.has("X-Remix-Replace") ? Action3.Replace : Action3.Push;
    let {
      formMethod,
      formAction,
      formEncType
    ...
    if (redirectPreserveMethodStatusCodes.has(redirect6.response.status) && activeSubmission && isMutationMethod(activeSubmission.formMethod)) {
...
async function convertDataStrategyResultToDataResult(dataStrategyResult) {
  ...
  if (isResponse(result)) {
    ...
    if (type === ResultType3.error) {
      return {
        type: ResultType3.error,
        error: new ErrorResponseImpl2(result.status, result.statusText, data3),
...
// node_modules/@remix-run/react/node_modules/@remix-run/server-runtime/dist/esm/mode.js
...
var json4 = (data3, init = {}) => {
  return json2(data3, init);
};
var defer4 = (data3, init = {}) => {
  return defer2(data3, init);
};
var redirect5 = (url, init = 302) => {
  return redirect3(url, init);
};
var replace3 = (url, init = 302) => {
  return replace2(url, init);
};
var redirectDocument3 = (url, init = 302) => {
  return redirectDocument2(url, init);
};
...
// node_modules/@remix-run/react/node_modules/@remix-run/server-runtime/dist/esm/headers.js
...
async function singleFetchActionStrategy(request, matches) {
  ...
  invariant5(actionMatch, "No action match found");
  ...
  if (isResponse3(result.result) || isRouteErrorResponse3(result.result)) {
    return {
...
async function singleFetchLoaderFetcherStrategy(request, matches) {
  ...
  invariant5(fetcherMatch, "No fetcher match found");
...
async function fetchAndDecode(url, init) {
  ...
  invariant5(res.body, "No response body to decode");
  try {
  ...
  return decode(body, {
    plugins: [(type, ...rest) => {
      ...
      if (type === "ErrorResponse") {
        ...
        return {
          value: new ErrorResponseImpl2(status, statusText, data3)
        };
      }
...
function unwrapSingleFetchResults(results, routeId) {
  let redirect6 = results[SingleFetchRedirectSymbol];
  if (redirect6) {
    return unwrapSingleFetchResult(redirect6, routeId);
  }
...
function unwrapSingleFetchResult(result, routeId) {
  if ("error" in result) {
    ...
    throw redirect3(result.redirect, {
...
function getRedirect(response) {
  ...
  let replace4 = response.headers.get("X-Remix-Replace");
  if (replace4) {
    headers["X-Remix-Replace"] = replace4;
  }
  return redirect(url, {
    status,
    headers
...
var NavLink2 = React8.forwardRef(({
  ...
  return React8.createElement(React8.Fragment, null, React8.createElement(NavLink, _extends6({}, props, prefetchHandlers, {
...
var Link2 = React8.forwardRef(({
  ...
  let href = useHref(to);
  let [shouldPrefetch, ref, prefetchHandlers] = usePrefetchBehavior(prefetch, props);
  return React8.createElement(React8.Fragment, null, React8.createElement(Link, _extends6({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to,
    "data-discover": getDiscoverAttr(discover, isAbsolute, props.reloadDocument)
  })), shouldPrefetch && !isAbsolute ? React8.createElement(PrefetchPageLinks, {
...
var Form2 = React8.forwardRef(({
  ...
  return React8.createElement(Form, _extends6({}, props, {
    ref: forwardedRef,
    "data-discover": getDiscoverAttr(discover, isAbsolute, props.reloadDocument)
  }));
});
...
function Links() {
  ...
  return React8.createElement(React8.Fragment, null, criticalCss ? React8.createElement("style", {
    ...
    key,
    link
  }) => isPageLinkDescriptor(link) ? React8.createElement(PrefetchPageLinks, _extends6({
    key
  }, link)) : React8.createElement("link", _extends6({
    key
  }, link))));
}
function PrefetchPageLinks({
  ...
  return React8.createElement(PrefetchPageLinksImpl, _extends6({
    page,
    matches
  }, dataLinkProps));
}
...
function PrefetchPageLinksImpl({
  ...
  return React8.createElement(React8.Fragment, null, dataHrefs.map((href) => React8.createElement("link", _extends6({
    key: href,
    rel: "prefetch",
    as: "fetch",
    href
  }, linkProps))), moduleHrefs.map((href) => React8.createElement("link", _extends6({
    key: href,
    rel: "modulepreload",
    href
    ...
    React8.createElement("link", _extends6({
      key
    }, link))
  )));
}
function Meta() {
  ...
  return React8.createElement(React8.Fragment, null, meta.flat().map((metaProps) => {
    ...
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return React8.createElement(Comp, _extends6({
    ...
    return React8.createElement("meta", _extends6({
...
import(${JSON.stringify(manifest.entry.module)});`;
    return React8.createElement(React8.Fragment, null, React8.createElement("script", _extends6({}, props, {
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: createHtml(contextScript),
      type: void 0
    })), React8.createElement("script", _extends6({}, props, {
      suppressHydrationWarning: true,
...
function DeferredHydrationScript({
  ...
  return React8.createElement(React8.Suspense, {
    fallback: (
      ...
      typeof document === "undefined" && deferredData && dataKey && routeId ? null : React8.createElement("script", _extends6({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: " "
    ...
    children: (data3) => {
      return React8.createElement("script", _extends6({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
  ...
  }) : React8.createElement("script", _extends6({}, scriptProps, {
    async: true,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
      __html: " "
  ...
  if (!router) {
    if (window.__remixContext.future.v3_singleFetch) {
      if (!stateDecodingPromise) {
        ...
        invariant5(stream, "No stream found for single fetch decoding");
...
function ScrollRestoration2({
  ...
  return React10.createElement("script", _extends6({}, props, {
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
...
function StaticRouterProvider({
  ...
  if (hydrate2 !== false) {
    ...
    let json5 = htmlEscape(JSON.stringify(JSON.stringify(data3)));
...
export {
  ...
  matchRoutes,
  parsePath,
  redirect5 as redirect,
  redirectDocument3 as redirectDocument,
  renderMatches,
  replace3 as replace,
  resolvePath,
